const stopWords = ['y', 'why', 'each', 'hasn', 'we', 'under', 'their', 'wouldn',
'how', 'against', 'being', 'other', 'hers', 'yours', 'only', 'you',
's', 'no', 'once', 'some', 'couldnt', 'over', 'did', 'needn',
'those', 'most', 'above', 'm', 'shouldn', 'an', 'from', 'but',
'doesn', 'weren', 'this', 'have', 'now', 'shouldnt', 'hadnt', 'im',
'ourselves', 'the', 'whom', 'can', 'here', 'arent', 'haven',
'mightnt', 'd', 'won', 'werent', 'by', 'because', 'nor', 'does',
'her', 'itself', 'until', 'youve', 'should', 'doesnt', 'out',
'she', 'didn', 'while', 'there', 'a', 'are', 've', 'he', 'if',
'what', 'am', 'about', 'youll', 'further', 'they', 'had', 'will',
'shes', 'again', 'has', 'i', 'between', 'then', 'ours', 'to',
'your', 'do', 'youre', 'them', 'and', 'shant', 'after', 't',
'wont', 'any', 'having', 'doing', 'where', 'his', 'below', 'him',
'up', 'me', 'so', 'was', 'ma', 'mightn', 'off', 'when', 'more',
'shouldve', 'couldn', 'too', 'these', 'be', 'our', 'don',
'yourself', 'themselves', 'isn', 'theirs', 'aren', 'isnt', 'shan',
'mustnt', 'very', 'than', 'down', 'or', 'were', 'my', 'wasn',
'not', 'all', 'is', 'hasnt', 'through', 'just', 'didnt', 'who',
'such', 're', 'mustn', 'during', 'it', 'thatll', 'in', 'with',
'which', 'at', 'of', 'o', 'wouldnt', 'youd', 'yourselves',
'herself', 'been', 'dont', 'neednt', 'himself', 'myself', 'havent',
'wasnt', 'same', 'hadn', 'as', 'few', 'its', 'before', 'll', 'for',
'ain', 'that', 'own', 'into', 'both', 'on', 'ada', 'adalah',
'adanya', 'adapun', 'agak', 'agaknya', 'agar', 'akan', 'akankah',
'akhir', 'akhiri', 'akhirnya', 'aku', 'akulah', 'amat', 'amatlah',
'anda', 'andalah', 'antar', 'antara', 'antaranya', 'apa', 'apaan',
'apabila', 'apakah', 'apalagi', 'apatah', 'artinya', 'asal',
...
'berikutnya', 'berjumlah', 'berkali-kali', 'berkata',
...
'dahulu', 'dalam', 'dan', 'dapat', 'dari', 'daripada', 'datang',
'dekat', 'demi', 'demikian', 'demikianlah', 'dengan', 'depan',
...
'dikira', 'dilakukan', 'dilalui', 'dilihat', 'dimaksud',
'dimaksudkan', 'dimaksudkannya', 'dimaksudnya', 'diminta',
'dimintai', 'dimisalkan', 'dimulai', 'dimulailah', 'dimulainya',
'dimungkinkan', 'dini', 'dipastikan', 'diperbuat', 'diperbuatnya',
'dipergunakan', 'diperkirakan', 'diperlihatkan', 'diperlukan',
'diperlukannya', 'dipersoalkan', 'dipertanyakan', 'dipunyai',
'diri', 'dirinya', 'disampaikan', 'disebut', 'disebutkan',
...
'justru', 'kala', 'kalau', 'kalaulah', 'kalaupun', 'kalian',
...
'ketika', 'khususnya', 'kini', 'kinilah', 'kira', 'kira-kira',
'kiranya', 'kita', 'kitalah', 'kok', 'kurang', 'lagi', 'lagian',
'lah', 'lain', 'lainnya', 'lalu', 'lama', 'lamanya', 'lanjut',
'lanjutnya', 'lebih', 'lewat', 'lima', 'luar', 'macam', 'maka',
...
'menanti', 'menanti-nanti', 'menantikan', 'menanya', 'menanyai',
'menanyakan', 'mendapat', 'mendapatkan', 'mendatang', 'mendatangi',
'mendatangkan', 'menegaskan', 'mengakhiri', 'mengapa',
...
'pertanyakan', 'pihak', 'pihaknya', 'pukul', 'pula', 'pun',
'punya', 'rasa', 'rasanya', 'rata', 'rupanya', 'saat', 'saatnya',
'saja', 'sajalah', 'saling', 'sama', 'sama-sama', 'sambil',
'sampai', 'sampai-sampai', 'sampaikan', 'sana', 'sangat',
...
'seberapa', 'sebesar', 'sebetulnya', 'sebisanya', 'sebuah',
'sebut', 'sebutlah', 'sebutnya', 'secara', 'secukupnya', 'sedang',
'sedangkan', 'sedemikian', 'sedikit', 'sedikitnya', 'seenaknya',
'segala', 'segalanya', 'segera', 'seharusnya', 'sehingga',
...
'seluruhnya', 'semacam', 'semakin', 'semampu', 'semampunya',
'semasa', 'semasih', 'semata', 'semata-mata', 'semaunya',
'sementara', 'semisal', 'semisalnya', 'sempat', 'semua',
'semuanya', 'semula', 'sendiri', 'sendirian', 'sendirinya',
'seolah', 'seolah-olah', 'seorang', 'sepanjang', 'sepantasnya',
...
'setidak-tidaknya', 'setidaknya', 'setinggi', 'seusai', 'sewaktu',
'siap', 'siapa', 'siapakah', 'siapapun', 'sini', 'sinilah', 'soal',
'soalnya', 'suatu', 'sudah', 'sudahkah', 'sudahlah', 'supaya',
'tadi', 'tadinya', 'tahu', 'tahun', 'tak', 'tambah', 'tambahnya',
'tampak', 'tampaknya', 'tandas', 'tandasnya', 'tanpa', 'tanya',
'tanyakan', 'tanyanya', 'tapi', 'tegas', 'tegasnya', 'telah',
'tempat', 'tengah', 'tentang', 'tentu', 'tentulah', 'tentunya',
...
'terus', 'terutama', 'tetap', 'tetapi', 'tiap', 'tiba',
...
'yang', 'nih', 'sih', 'gue', 'lu', 'uniform', 'resource',
'locator', 'nya', 'ya']